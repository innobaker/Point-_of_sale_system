                            ...
                            <tbody>
                                <tr>
                                    <td style="text-align: center;" colspan="2">
                                        <h4 style="font-size: 23px; line-height: 30px; margin:2px; padding:0">Winotech General supplies. </h4>
                        ...
                        ?>
                            <div class="table-responsive mb-3">
                                <table style="width: 100%;" cellpadding="5">
                                    <thead>
                                  <th style="border-bottom: 1px solid #ccc; text-align: left;" width="5%">ID</th>
                                    <th style="border-bottom: 1px solid #ccc; text-align: left;">Product Name</th>
                                    <th style="border-bottom: 1px solid #ccc; text-align: left;" width="15%">Price</th>
                                    <th style="border-bottom: 1px solid #ccc; text-align: left;" width="10%">Quantity</th>
                                    <th style="border-bottom: 1px solid #ccc; text-align: left;" width="15%">Total Price</th>
